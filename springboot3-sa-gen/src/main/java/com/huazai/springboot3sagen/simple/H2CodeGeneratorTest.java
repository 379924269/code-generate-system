package com.huazai.springboot3sagen.simple;
...
public class H2CodeGeneratorTest extends BaseGeneratorTest {
    ...
    public void testCustomTemplatePath() {
        ...
        pathInfo.put(OutputFile.xml, "H:\\000");
        pathInfo.put(OutputFile.entity, "H:\\000\\entity");
        AutoGenerator generator = new AutoGenerator(DATA_SOURCE_CONFIG);
        generator.strategy(strategyConfig().build());
    ...
    public void testCustomTemplate() {
        AutoGenerator generator = new AutoGenerator(DATA_SOURCE_CONFIG);
        generator.strategy(strategyConfig().controllerBuilder().template("/templates/controller1.java").build());
